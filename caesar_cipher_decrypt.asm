;   Executable name : caesarcipherdecrypt
;   Version         : 1.0
;   Created date    : Mon, 07/08/2026
;   Last Update     : Mon, 07/08/2026
;   Author          : Opoku N. Chris
;   Description     : An assembly language program that decrypts text using Caesar
;                     Cipher algorithm
;
;
; Build using these commands:
;   nasm -­f elf64 -­g -­ F stabs caesarcipherdecrypt.asm
;   ld -­ o caesarcipherdecrypt caesarcipherdecrypt.o
;               or
...
; Set up the registers for the translate step:
    mov rbx,CaesarCipherDecrypt     ; Put the address of the table into rbx
